...
export default function Index() {
  ...
  return (
    ...
    <View className="flex-1 bg-white justify-center items-center p-0 font-sans">
      ...
      <Text className="text-2xl font-bold text-gray-800 mb-4 font-lato">Save, Borrow, Invest</Text>
      <Text className="text-base pb-5 text-center font-lato">ChamaVault is a digital platform for Chamas to save, borrow and invest money.</Text>
    
       <TouchableOpacity className="w-full bg-yellow-600 p-4 rounded-full mt-8" onPress={() => router.push("/register")}>
        <Text className="text-white text-center font-semibold text-lg font-lato">Create new account</Text>
      </TouchableOpacity>
      <TouchableOpacity className="w-full bg-green-600 p-4 rounded-full mt-8" onPress={() => router.push("/login")}>
        <Text className="text-white text-center font-semibold text-lg font-lato">I already have an account</Text>
      </TouchableOpacity>
    </View>
    </ScrollView>
        <StatusBar
