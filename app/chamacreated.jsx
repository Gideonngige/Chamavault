  ...
  const { chama} = route.params;
    ...
    return(
        <View className="flex-1 bg-white justify-center items-center p-5 font-sans">
              ...
              <Text className="text-lg font-bold font-lato">{chama} created Successfully</Text>
              
              <TouchableOpacity className="w-full bg-yellow-600 p-4 rounded-lg" onPress={handleInviteMembers}>
                <Text className="text-white text-center font-semibold text-lg font-lato">Invite members</Text>
              </TouchableOpacity>
              <StatusBar
